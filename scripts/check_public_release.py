...
REQUIRED_PATHS = (
    ...
    "scripts/prepare_sdk_repository.py",
    "skills/glic-metal-sdk-integration/SKILL.md",
    "skills/glic-metal-sdk-integration/agents/openai.yaml",
    "skills/glic-metal-sdk-integration/references/integration-map.md",
    "skills/glic-metal-sdk-integration/references/verification.md",
    "skills/glic-metal-sdk-integration/scripts/inspect_glic_metal_sdk.py",
    "scripts/build_vvc_reference.py",
    "scripts/build_ffmpeg_hevc_glitch_reference.py",
    "scripts/build_x264_glitch_reference.py",
    "scripts/build_x265_glitch_reference.py",
    ...
    "scripts/x265_analysis_glitch.py",
    "patches/x265-4.2-glic-entropy-hooks.patch",
    "patches/x265_glic_entropy_hook.h",
    "patches/x264-0480cb0-glic-entropy-hooks.patch",
    "patches/x264_glic_entropy_hook.h",
    "patches/x264_glic_entropy_hook.c",
    "patches/ffmpeg-8.0.1-hevc-glic-decoder-hooks.patch",
    "patches/ffmpeg_hevc_glic_decoder_hook.h",
    "patches/ffmpeg_hevc_glic_decoder_hook.c",
    ...
    "tests/test_glic_metal_sdk_skill.py",
    "tests/test_prepare_sdk_repository.py",
    "tests/test_codec_lab.py",
    "tests/test_glitch_gallery.py",
    "tests/test_native_syntax_glitch.py",
    "tests/test_x265_analysis_glitch.py",
    "tests/test_x265_entropy_hook.py",
    "tests/test_x264_entropy_hook.py",
    "tests/test_ffmpeg_hevc_decoder_hook.py",
