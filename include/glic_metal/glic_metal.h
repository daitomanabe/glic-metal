...
enum {
  ...
  GLIC_METAL_EFFECT_TILE_SHUFFLE = 9,
  GLIC_METAL_EFFECT_VERTICAL_TEAR = 10,
  GLIC_METAL_EFFECT_DIAGONAL_SLIP = 11,
  GLIC_METAL_EFFECT_SCANLINE_WEAVE = 12,
  GLIC_METAL_EFFECT_QUAD_MIRROR = 13
};
