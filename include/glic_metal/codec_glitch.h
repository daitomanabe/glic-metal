...
enum {
  ...
  GLIC_CODEC_GLITCH_DUAL_CODEC_CROSSBREED = 18,
  GLIC_CODEC_GLITCH_CODEC_PINGPONG = 19,
  GLIC_CODEC_GLITCH_GOP_ACCORDION = 20,
  GLIC_CODEC_GLITCH_BFRAME_BRAID = 21,
  GLIC_CODEC_GLITCH_PLANE_SPLIT_CODEC = 22,
  GLIC_CODEC_GLITCH_ROI_QUALITY_ISLANDS = 23,
  GLIC_CODEC_GLITCH_CODEC_PHASE_MOSAIC = 24,
  GLIC_CODEC_GLITCH_ENCODER_HOT_SWAP = 25,
  GLIC_CODEC_GLITCH_PTS_RUBBERBAND = 26,
  GLIC_CODEC_GLITCH_BITRATE_RASTER = 27,
  GLIC_CODEC_GLITCH_PLANE_TIME_SPLIT = 28,
  GLIC_CODEC_GLITCH_REFERENCE_ATLAS = 29,
  GLIC_CODEC_GLITCH_FLOW_LATTICE = 30,
  GLIC_CODEC_GLITCH_SCAN_ORDER_FOLD = 31,
  GLIC_CODEC_GLITCH_REGIONAL_GOP_CLOCK = 32,
  GLIC_CODEC_GLITCH_ENTROPY_FEEDBACK = 33,
  GLIC_CODEC_GLITCH_ROLLING_TIME_SHUTTER = 34,
  GLIC_CODEC_GLITCH_ASYMMETRIC_PLANE_CODEC = 35
};
